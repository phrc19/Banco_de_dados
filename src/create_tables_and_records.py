...
def run():
    ...
    with open("//home/labdatabase/Documents/Trabalho/src/create_table.sql") as f:
        query_create = f.read()
    ...
    with open("//home/labdatabase/Documents/Trabalho/src/inserindo.sql") as f:
        query_generate_related_records = f.read()

    print("Gerenating records")
    generate_records(query=query_generate_related_records)
